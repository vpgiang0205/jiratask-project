...
import { actSignup } from '../../redux/actions/actAuth';
...
export default function Signup() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        dispatch(actSignup(state, navigate))
        console.log(state);
    }
    ...
    return (
        <div className='login-page d-md-flex' style={{ minHeight: '100vh' }}>
            ...
            <div className='col-md-5 d-flex m-auto justify-content-center align-items-center'>
                <div className="">
                    <h2 className="text-center text-dark main__Title">SIGNUP ACCOUNT</h2>
                    <form onSubmit={handleSubmit} className='align-items-center mt-4'>
                        ...
                        <div className='mt-3'>
                            <input type="text" name="name" className="form-control" required placeholder='Tên' onChange={handleOnChange} />
                        </div>
                        ...
                        <div className='mt-3'>
                            <input type="text" name="phoneNumber" className="form-control" required placeholder='Số điện thoại' onChange={handleOnChange} />
                        </div>
                        ...
                        <div className=' text-center'>
                            ...
                            <div className="">
                                <NavLink to="/signin-page" className="cursor-pointer"> Bạn có tài khoản ? Sign in</NavLink>
                            </div>
                        </div>
                    </form>
                </div>
